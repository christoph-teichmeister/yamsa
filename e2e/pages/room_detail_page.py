...
class RoomDetailPage(BasePage):
    """The room, which reads and edits in the same place.
    ...
    def enter_edit_mode(self):
        self.page.locator("#edit-room-button").click()
        expect(self.page.locator("#save-room-button")).to_be_visible()

    def cancel_edit_mode(self):
        self.page.locator("#cancel-room-button").click()
        expect(self.page.locator("#edit-room-button")).to_be_visible()
    ...
    def details_section_offset(self) -> float:
        return self.page.locator("#name").evaluate("(field) => field.getBoundingClientRect().top")
    ...
    def expect_edit_button_absent(self):
        expect(self.page.locator("#edit-room-button")).to_have_count(0)
