...
env = environ.Env(
    ...
    DJANGO_PAYMENT_REMINDER_ENABLED=(bool, True),
    DJANGO_PAYMENT_REMINDER_INACTIVITY_DAYS=(int, 30),
    DJANGO_PAYMENT_REMINDER_SENDER_EMAIL=(str, "reminders@yamsa.local"),
    # Sentry ENV
    SENTRY_DSN=(str, ""),
...
PAYMENT_REMINDER_ENABLED = env("DJANGO_PAYMENT_REMINDER_ENABLED")
PAYMENT_REMINDER_INACTIVITY_DAYS = env("DJANGO_PAYMENT_REMINDER_INACTIVITY_DAYS")
PAYMENT_REMINDER_SENDER_EMAIL = env("DJANGO_PAYMENT_REMINDER_SENDER_EMAIL")
