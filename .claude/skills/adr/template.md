...
- Status: "{proposed | rejected | accepted | deprecated | … | superseded by [ADR-9999](9999-template.md)}"
...
- Components: {comma-separated list of affected components, e.g. Backend, Frontend, Infrastructure, Documentation}
...
In order to [business or technology goal] as [persona] I [want to].
