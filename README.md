...
- Tailwind, Bootstrap Icons, HTMX, and Idiomorph are bundled through Webpack (see `apps/static_src/tailwind.css`, `apps/static/js/icons.js` and `apps/static/js/htmx.js`), so rebuild after touching those entry files or their dependencies.
